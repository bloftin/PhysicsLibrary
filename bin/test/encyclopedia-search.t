...
my $html;
{
    ...
    like($html,qr/Browse and search Encyclopedia/,'encyclopedia list heading');
    ...
    like($html,qr/Type: Example/,'article type shown');
    ...
    like($empty,qr/Nothing to show/,'empty results keep the form and clear link');
    like($empty,qr/>clear<\/a>/,'clear action for filtered results');
