...
function drawRoot(){
 ...
 label(ctx,`lo ${fmt(r.lo,6)}`,sx(r.lo),yBracket-18,"center",colors.cycloid,"13px system-ui");label(ctx,`mid ${fmt(r.mid,6)}`,sx(r.mid),yBracket+50,"center",colors.accent,"13px system-ui");label(ctx,`hi ${fmt(r.hi,6)}`,sx(r.hi),yBracket-18,"center",colors.cycloid,"13px system-ui");
